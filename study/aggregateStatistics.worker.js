...
onmessage = async event => {
    ...
    destinationMatcher.import(data.destinationMatches);
    referrerMatcher = webScience.matching.createMatchPatternSet([])
    referrerMatcher.import(data.referrerMatches);
    fbMatcher = webScience.matching.createMatchPatternSet([])
    fbMatcher.import(data.fbMatches);
    ytMatcher = webScience.matching.createMatchPatternSet([])
    ytMatcher.import(data.ytMatches);
    twMatcher = webScience.matching.createMatchPatternSet([])
    twMatcher.import(data.twMatches);
...
const functionMapping = {
    "NewsAndDisinfo.pageNavigation.pageVisits": pageNavigationStats,
    "NewsAndDisinfo.linkExposure.linkExposures": linkExposureStats,
    "NewsAndDisinfo.socialMediaLinkSharing.linkShares": socialMediaLinkSharingStats,
}
